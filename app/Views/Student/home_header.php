    ...
    <section class="header">
        <div class="header-bac">
            <div style="width: 30%;float: left; margin-top: 10px;">
                ...
                <a href="<?php echo base_url() ?>/Mobile_app/Profile"><img
                        src="<?php echo base_url(); ?>/assets/upload/profile/<?php echo $proImg; ?>" alt="banner"
                        class="img-pro"></a>
            </div>
            ...
            <div style="width: 30%;float: left;text-align: right; margin-top: 10px;">
                <a href="" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><img
                        src="<?php echo base_url(); ?>/assets/image/icon-settings.svg" alt="banner" class="h-ico"></a>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="<?php echo base_url('/Mobile_app/Payment') ?>">My Payment</a>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo base_url('/Mobile_app/SignUp/logout') ?>">LogOut</a>
                    </li>
                </ul>
            </div>
        </div>
        <img src="<?php echo base_url(); ?>/assets/image/porasona vari moja.png" alt="banner" class="home-banner">
    </section>