...
<section class="content-2" style="margin-bottom: 90px;">
    <div class="row pt-2">
        <div class="col-12 text-center mt-2" >
            <h4><?php echo get_data_by_id('name','subject','subject_id',$subjectId) ?> Questions</h4>
            <?php if(!empty($quiz)){?>
                <div class="col-12 mt-2 d-flex justify-content-between mt-4" >
                    <span class="fc-ti-2" >Model Test</span>
                ...
                <?php foreach ($quiz as $key => $qu){ ?>
                    ...
                    <div class="col-12 mt-2 q-ans" >
                        <!-- line -->
                        <input type="hidden" id="quiz_id" value="<?php echo $qu->quiz_id?>">
