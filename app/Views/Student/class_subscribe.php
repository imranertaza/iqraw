            ...
            <form id="subscribe_form" class="form-inline" action="<?php print API_URL; ?>" method="POST">
                ...
                <?php foreach ($pack as $key => $pa) { ?>
                    <div class="form-check box mt-3">
                        <input class="form-check-input" onclick="pack_sub_calculate()" type="radio" data-price="<?php echo $pa->m_fee; ?>" name="class_subscription_package_id" id="exampleRadios_<?php echo $pa->class_subscription_package_id; ?>" value="<?php echo $pa->class_subscription_package_id; ?>" <?php if (!isset(newSession()->packId)) {
                                                                                                                                                                                                                                                                                                                    echo ($key == 0) ? 'checked' : '';
                                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                                    echo (newSession()->packId == $pa->class_subscription_package_id) ? 'checked' : '';
                                                                                                                                                                                                                                                                                                                } ?>>
                ...
                <table class="table mt-5 text-center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><button type="submit" class="btn a-btn text-white mt-3">Continue</button>
                            </td>
                        </tr>
                        <td colspan="2">
                            <p>পেমেন্ট করতে সমস্যা হলে এখানে ক্লিক করুন</p>
                            <a href="#" class="text-decoration-none" onclick="paymentmethod('<?php print base_url('/Mobile_app/Class_subscribe/sub_manual_action'); ?>'),formSubmit()">Manual
                                pay</a>
