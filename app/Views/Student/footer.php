...
<nav class="navbar navbar-expand-md navbar-dark fixed-bottom p-2 footer" id="reloadCart">
    <!--    <a class="navbar-brand" href="#"><img src="--><?php //echo base_url(); 
                                                            ?>
    <!--/assets/image/icon-w.svg" alt=""></a>-->
    <!--    --><?php //if ($footer_icon == 'Shopping'){ 
                ?>
    <!--        <a class="navbar-brand" href="--><?php //echo $cart_url;
                                                    ?>
    <!--"><div class="h-icon-bg"><img src="--><?php //echo base_url(); 
                                                ?>
    <!--/assets/image/icon-shopping-w.svg" alt="" style="margin-top: 13px;"></div> --><?php //if (!empty(Cart()->totalItems())){
                                                                                        ?>
    <!--                <span class="position-absolute translate-middle badge rounded-pill bg-danger " style="top:20px;" >--><?php //echo Cart()->totalItems();
                                                                                                                                ?>
    <!--</span>-->
    <!--            --><?php //} 
                        ?>
    ...
    <!--    <a class="navbar-brand" href="--><?php //echo base_url() 
                                                ?>
    <!--/Mobile_app/Shopping"><img src="--><?php //base_url(); 
                                            ?>
    <!--/assets/image/icon-shopping.svg" alt=""></a>-->
    <!--    --><?php //} 
                ?>
    <!--    <a class="navbar-brand" href="--><?php //echo base_url() 
                                                ?>
    <!--/Mobile_app/Notice"><img src="--><?php //echo base_url(); 
                                            ?>
    <!--/assets/image/icon-notification.svg" alt="">--><?php //if (noticeCount() != 0){ 
                                                        ?>
    <!-- <span class="badge">--><?php //echo noticeCount();
                                ?>
    <!--</span>--><?php //} 
                    ?>
    <!-- </a>-->
    ...
    <?php } else { ?>
        <a class="navbar-brand" href="<?php echo base_url() ?>/Mobile_app/Notice"><img src="<?php echo base_url(); ?>/assets/image/icon-notification.svg" alt=""><?php if (noticeCount() != 0) { ?>
                <span class="badge"><?php echo noticeCount(); ?></span><?php } ?> </a>
    <?php } ?>


    <?php if ($footer_icon == 'Home') { ?>
        <a class="navbar-brand" href="<?php echo base_url() ?>/Mobile_app/Dashboard">
            <div class="h-icon-bg"><img src="<?php echo base_url(); ?>/assets/image/icon-home-alt.svg" alt="" style="margin-top: 11px;"></div>
        </a>
    <?php } else { ?>
    ...
    <?php if ($footer_icon == 'Ranking') { ?>
        <a class="navbar-brand" href="<?php echo base_url() ?>/Mobile_app/Ranking">
            <div class="h-icon-bg"><img src="<?php echo base_url(); ?>/assets/image/icon-badge-rank-w.svg" alt="" style="margin-top: 11px;"></div>
        </a>
    <?php } else { ?>
