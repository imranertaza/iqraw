    ...
    <div class="row pt-2">
        ...
        <div class="col-12">
            <table class="table text-capitalize">
                <tbody>
                <?php foreach ($student as $val){ $you = ($val->std_id == newSession()->std_id)?'You':''; $url = ($val->std_id == newSession()->std_id)?base_url('Student/Profile'):'#';  ?>
                    <tr class="<?php echo $you;?>">
                        <td width="150" style="padding-top: 15px;" class="<?php echo $you;?>_p"><a href="<?php echo $url?>"><?php echo $val->name;?></a></td>
