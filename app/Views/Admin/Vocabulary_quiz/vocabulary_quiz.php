            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Vocabulary Quiz</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Vocabulary Quiz List</h3>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-form" class="pl-3 pr-3">
                        ...
                        <div class="form-group text-center">
                            <div class="btn-group">
                                <input type="hidden" class="form-control" name="voc_quiz_id" id="voc_quiz_id" required>
...
<script>
    ...
    function edit(voc_quiz_id) {
        $.ajax({
            url: '<?php echo base_url($controller . '/getOne') ?>',
            type: 'post',
            data: {
                voc_quiz_id: voc_quiz_id
            },
            //dataType: 'json',
            success: function (response) {
                // reset the form
                ...
                $("#edit-form #voc_quiz_id").val(response.voc_quiz_id);
