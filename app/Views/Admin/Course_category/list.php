                ...
                <div class="modal-body text-capitalize">
                    <form id="add-form" class="pl-3 pr-3"  enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <label for="chapter_id">Course: </label>
                ...
                <div class="modal-body">
                    <form id="edit-form" class="pl-3 pr-3">
                        <div class="row">
                            ...
                            <div class="form-group text-center">
                                <div class="btn-group">
                                    <input type="hidden" class="form-control" name="course_cat_id" id="course_cat_id" required>
    ...
    function edit(course_cat_id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit-form #category_name").val(response.category_name);
