...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Skill Question</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Skill Question</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Skill Question List</h3>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-form" class="pl-3 pr-3">
                        ...
                        <div class="form-group text-center">
                            <div class="btn-group">
                                <input type="hidden" class="form-control" name="skill_question_id" id="skill_question_id" required>
...
<script>
    ...
    function edit(skill_question_id) {
        $.ajax({
            url: '<?php echo base_url($controller . '/getOne') ?>',
            type: 'post',
            data: {
                skill_question_id: skill_question_id
            },
            //dataType: 'json',
            success: function (response) {
                // reset the form
    ...
    function remove(skill_question_id) {
        Swal.fire({
