                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Chapter Video List</h3>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-primary btn-sm filter" onclick="chapter_video_Filter()" style="margin-top: 35px;">Filter</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="video_id" id="video_id" required>
                                </div>
                            </div>
    ...
    function edit(video_id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit-form #video_id").val(response.video_id);
