                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Vocabulary List</h3>
                            </div>
                            <div class="col-md-4">
                    ...
                    <form id="edit-form" class="pl-3 pr-3">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="bangla">Bangla: </label>
                                    <input type="text" class="form-control" name="bangla" id="bangla" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center">
                            <div class="btn-group">
                                <input type="hidden" name="voc_id" id="voc_id" >
    ...
    function edit(voc_id) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#edit-form #voc_id").val(response.voc_id);
                $("#edit-form #english").val(response.english);
                $("#edit-form #bangla").val(response.bangla);
