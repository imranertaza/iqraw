            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">User Roll</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">User Roll List</h3>
                            </div>
                            <div class="col-md-4">
                                    ...
                                    <ol>
                                        ...
                                        <li><?php echo $key;?>
                                            ...
                                            <div class="form-check">
                                                <label> <input class="form-check-input" type="checkbox" name="permission[<?php print $key; ?>][<?php print $k; ?>]" value="1" ><?php echo $k ?></label>
                                            </div>
                                            <?php }?>
                                        </li>
                                        <?php  }?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="role_id" id="role_id" required>
                                </div>
                            </div>
