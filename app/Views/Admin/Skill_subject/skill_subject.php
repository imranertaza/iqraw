            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Skill subject</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Skill subject List</h3>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Skill Subject  Name: </label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="skill_subject_id" id="skill_subject_id" required>
                                </div>
                            </div>
...
<script>
    ...
    function edit(skill_subject_id) {
        $.ajax({
    ...
    function remove(skill_subject_id) {
        Swal.fire({
