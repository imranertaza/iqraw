                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" id="class_id" onchange="check_class_group(this.value)" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="class_group_id_sear" >
                                        <option value="">Please select</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <button class="btn btn-primary btn-sm filter" onclick="subjectFilter()" style="margin-top: 35px;">Filter</button>
                            </div>
    ...
    function check_class_group(class_id){
        $.ajax({
            ...
            success: function (val) {
                ...
                $("#class_group_id_sear").html(val);
            }
        });
    }

    function subjectFilter(){
        var class_group_id = $("#class_group_id_sear").val();
        var classId = $("#class_id").val();

        $.ajax({
            url: '<?php echo base_url($controller . '/filter') ?>',
            type: 'post',
            data: {class_group_id:class_group_id,class_id:classId},
            beforeSend: function () {
