            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-form" class="pl-3 pr-3">
                        ...
                        <div class="form-group text-center">
                            <div class="btn-group">
                                <input type="hidden" class="form-control" name="quiz_question_id" id="quiz_question_id" required>
...
<script>
    ...
    function edit(quiz_question_id) {
        $.ajax({
    ...
    function remove(quiz_question_id) {
        Swal.fire({
