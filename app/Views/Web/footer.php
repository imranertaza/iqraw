        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-3 col-sm-12 col-lg-3">
                    ...
                    <p class="ft-con-t"><a target="_blank"
                            href="https://wa.me/<?php echo get_settings_value_by_label('whatsapp_number'); ?>"
                            class="text-decoration-none text-white">Contact at <svg xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" height="20px" width="20px" version="1.1"
                                id="Capa_1" viewBox="0 0 58 58" xml:space="preserve">
                                <g>
                ...
                <div class="col-12 text-center" style="padding: 20px 0px;">
                    ...
                    <a href="#" class="fo-icon-f"><img src="<?php echo base_url() ?>/assets_web/image/ft-twitter.svg"
                            alt=""></a>
                    <a href="#"><img src="<?php echo base_url() ?>/assets_web/image/ft-pinterest-logo-thin.svg"
                            alt=""></a>
                </div>
            </div>
        </div>
