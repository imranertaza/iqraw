...
class Shopping extends BaseController
{
    ...
    public function index()
    {
        ...
        if (!isset($isLoggedInStudent) || $isLoggedInStudent != TRUE) {
            ...
            $data['cart_url'] = base_url('/Mobile_app/Shopping/cart');
            $data['category_url'] = base_url('/Mobile_app/Shopping/category');
    ...
    public function details($id)
    {
        ...
        if (!isset($isLoggedInStudent) || $isLoggedInStudent != TRUE) {
            ...
            $data['back_url'] = base_url('/Mobile_app/Shopping');
            $data['cart_url'] = base_url('/Mobile_app/Shopping/cart');
    ...
    public function search()
    {
        ...
        foreach ($product as $pro) {
            $url = base_url('/Mobile_app/Shopping/details/' . $pro->prod_id);
    ...
    public function checkout()
    {
        ...
        if (!isset($isLoggedInStudent) || $isLoggedInStudent != TRUE) {
            ...
            $data['back_url'] = base_url('/Mobile_app/Shopping/cart');
            $data['cart_url'] = base_url('/Mobile_app/Shopping/cart');
            $data['footer_icon'] = 'Shopping';
    ...
    public function buy_action()
    {
        ...
        $this->cart->destroy();
        return redirect()->to(site_url('/Mobile_app/Shopping/invoice/'.$orderId));
    ...
    public function invoice($id){
        ...
        if (!isset($isLoggedInStudent) || $isLoggedInStudent != TRUE) {
            ...
            $data['back_url'] = base_url('/Mobile_app/Shopping/order_list');
            $data['cart_url'] = base_url('/Mobile_app/Shopping/cart');
