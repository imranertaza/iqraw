...
<!--        <span class="f-ti-1"><a class="btn sub-btn" href="javascript:void(0)" > Submit </a></span>-->
    ...
    <?php }else{?>
        <span class="f-ti-1"><a class="btn sub-btn" href="javascript:void(0)" onclick="mcqanscatculate('<?php echo base_url(); ?>/Student/Skill_development/result_view')"> Submit </a></span>
    <?php } ?>
</nav>
