...
class Pager implements PagerInterface
{
    ...
    public function customLinks(string $group = 'default', string $template = 'custom_full'): string
    {
        $this->ensureGroup($group);
    ...
    public function quizecustomLinks(string $group = 'default', string $template = 'custom_quiz'): string
    {
        $this->ensureGroup($group);
    ...
    public function mcqcustomLinks(string $group = 'default', string $template = 'custom_mcq'): string
    {
        $this->ensureGroup($group);
